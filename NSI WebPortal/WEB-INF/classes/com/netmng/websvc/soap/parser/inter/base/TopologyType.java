 ...
 *         &lt;element name="BidircetionalPort" type="{http://schemas.ogf.org/nml/2013/05/base#}BidirectionalPortType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends NetworkObject
{
    ...
    @XmlElement(name = "BidircetionalPort")
    protected List<BidirectionalPortType> bidircetionalPort;
    ...
    /**
     * Gets the value of the bidircetionalPort property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the bidircetionalPort property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getBidircetionalPort().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<BidirectionalPortType> getBidircetionalPort() {
        if (bidircetionalPort == null) {
            bidircetionalPort = new ArrayList<BidirectionalPortType>();
        }
        return this.bidircetionalPort;
    }
