...
<%
	...
	if(list!=null && list.size()>0){
		...
		for(int i=0; i<list.size(); i++){
			QuerySummaryResultType queryResultType = list.get(i);
			
			List<QuerySummaryResultCriteriaType> listCriteria = queryResultType.getCriteria();
...
%>		
		...
		<tbody>
			...
			<tr>
				...
				<td align="left" valign="middle"><%=StrUtil.nullToStr(criteria.getOtherAttributes().get("dynamicKL_srcHostIP"))%>
				...
				<td align="left" valign="middle"><%=StrUtil.nullToStr(criteria.getOtherAttributes().get("dynamicKL_destHostIP"))%>
			...
			<tr>
				...
				<td align="left" valign="middle"><%=StrUtil.nullToStr( String.valueOf(evts.getMtu()) )%>
				...
				<td align="left" valign="middle"><%=StrUtil.nullToStr( String.valueOf(evts.getBurstsize()) )%>
