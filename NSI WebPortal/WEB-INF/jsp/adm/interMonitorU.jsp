...
<script type="text/javascript">
	...
	function reserveUpdate(){
		disableConfirm();
		$("#reservationDTO").attr("action", "${pageContext.request.contextPath}/adm/proc/interMonitorUP.do").attr("target", "_proc").submit();
	}
	function goList() {
		$("#listFrm").attr("action", "${pageContext.request.contextPath}/adm/interMonitorL.do").submit();
	}
	function goView() {
		$("#reservationDTO").attr("action", "${pageContext.request.contextPath}/adm/interMonitorV.do").submit();
	}
	
	function goListSeq(seq) {
		$("#listFrm").find("#seq").val(seq);
		$("#listFrm").attr("action", "${pageContext.request.contextPath}/adm/interMonitorV.do").submit();
	}
