...
<c:if test="${mode == 'RESERVE_FAV_I'}">
<script type="text/javascript">
	alert("<s:message code='com.netmng.ctrl.nsa.reserveFav.insert.success' />");
	sleep(200);
	parent.goListSeq(<c:out value="${seq}" />);
</script>
</c:if>

<c:if test="${mode == 'RESERVE_FAV_U'}">
<script type="text/javascript">
	alert("<s:message code='com.netmng.ctrl.nsa.reserveFav.update.success' />");
	sleep(200);
	parent.goUpdateSeq(<c:out value="${seq}" />);
</script>
</c:if>

<c:if test="${mode == 'RESERVE_FAV_D'}">
<script type="text/javascript">
	alert("<s:message code='com.netmng.ctrl.nsa.reserveFav.delete.success' />");
	sleep(200);
	parent.goListSeq(<c:out value="${seq}" />);
</script>
</c:if>
