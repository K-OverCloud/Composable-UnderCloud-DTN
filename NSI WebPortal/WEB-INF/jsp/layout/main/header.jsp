...
<div class="global" style="margin:0 auto; width:1022px; z-index:3;">
	...
	<div style="position:absolute; width:1010px; height:15px; right:0px;z-index:1;  text-align:right;">
		<ul>
			<li class="global">
				<a>
					<img src="${pageContext.request.contextPath}/images/${pageContext.response.locale.language}/top_title.gif" width="370" height="22" usemap="#Map3" align="right" border="0">
					<map name="Map3">
						<area shape="rect" coords="4,3,374,19" href="http://dynamickl.kreonet.re.kr">
					</map>
				</a>
			</li>
		</ul>
